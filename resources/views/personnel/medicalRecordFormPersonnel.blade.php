...
<label for="CP_address" class="form-label h6">Contact Person Address<span class="text-danger">*</span></label>
...
<div class="col-md-2">
    <label for="CP_addressRegion" class="form-label h6">Region<span class="text-danger">*</span></label>
    <select class="form-select  @error('CP_addressRegion') is-invalid @enderror" id="CP_addressRegion" name="CP_addressRegion">
        <option selected="selected" disabled="disabled" value="">SELECT</option>
        @foreach ($regions as $region)
            <option value="{{ $region['number'] }}" {{ old('region') == $region['number'] ? 'selected' : '' }}>
                {{ $region['number'] }} - {{ $region['name'] }}
    ...
    <span class="text-danger"> 
        @error('CP_addressRegion') 
          {{ $message }} 
        @enderror
    </span>
</div>
<div class="col-md-2">
    <label for="CP_addressProvince" class="form-label h6">Province<span class="text-danger">*</span></label>
        <select class="form-select  @error('CP_addressProvince') is-invalid @enderror" id="CP_addressProvince" name="CP_addressProvince">
            <option selected="selected" disabled="disabled" value="">SELECT</option>
        </select>
    <div class="invalid-feedback">
        Please enter your Province.
...
<script>
    ...
    $(document).ready(function() {
        // get the selected region
        var region = $('#CP_addressRegion').val();
        // get the corresponding provinces from the provinces object
        var selectedProvinces = provinces[region];
        // update the list of provinces in the dropdown
        var $provincesDropdown = $('#CP_addressProvince');
        $provincesDropdown.empty();
        $.each(selectedProvinces, function(i, province) {
            $provincesDropdown.append($('<option>').text(province).attr('value', province));
        });
        ...
        // when the region selection changes, update the list of provinces
        $('#CP_addressRegion').on('change', function() {
            var region = $(this).val();
            var selectedProvinces = provinces[region];
            var $provincesDropdown = $('#CP_addressProvince');
            $provincesDropdown.empty();
        ...
        <div class="col-md-2">
            <label for="CP_addressCityMunicipality" class="form-label h6">City/Municipality<span class="text-danger">*</span></label>
            <input type="text" class="form-control @error('CP_addressCityMunicipality') is-invalid @enderror" id="CP_addressCityMunicipality" name="CP_addressCityMunicipality" value="{{ old('CP_addressCityMunicipality') }}" oninput="this.value = this.value.toUpperCase()">
            <div class="invalid-feedback">
                Please enter your City/Municipality.
            </div>
            <span class="text-danger"> 
                @error('CP_addressCityMunicipality') 
                {{ $message }} 
                @enderror
            </span>
        </div>
        <div class="col-md-3">
            <label for="CP_addressBrgySubdVillage" class="form-label h6">Barangay/Subdivision/Village<span class="text-danger">*</span></label>
            <input type="text" class="form-control @error('CP_addressBrgySubdVillage') is-invalid @enderror" id="CP_addressBrgySubdVillage" name="CP_addressBrgySubdVillage" value="{{ old('CP_addressBrgySubdVillage') }}" oninput="this.value = this.value.toUpperCase()">
            <div class="invalid-feedback">
                Please enter your Barangay.
            </div>
            <span class="text-danger"> 
                @error('CP_addressBrgySubdVillage') 
                {{ $message }} 
                @enderror
            </span>
        </div>
        <div class="col-md-3">
            <label for="CP_addressHouseNoStreet" class="form-label h6">House No./Street Name<span class="text-danger">*</span></label>
            <input type="text" class="form-control @error('CP_addressHouseNoStreet') is-invalid @enderror" id="CP_addressHouseNoStreet" name="CP_addressHouseNoStreet" value="{{ old('CP_addressHouseNoStreet') }}" oninput="this.value = this.value.toUpperCase()">
            <div class="invalid-feedback">
                Please enter your House No./Street Name.
            </div>
            <span class="text-danger"> 
                @error('CP_addressHouseNoStreet') 
                {{ $message }} 
                @enderror
            </span>
        </div>
